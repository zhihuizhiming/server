...
class SettingsController extends Controller
{
     ...
     */
    public function __construct($AppName, IRequest $request, IL10N $l10n, TrustedServers $trustedServers)
    {
    ...
    public function addServer($url)
    {
        ...
        return new DataResponse(['url' => $url, 'id' => $id, 'message' => (string) $this->l->t('Added to the list of trusted servers')]);
    }
    /**
     * add server to the list of trusted ownClouds
     *
    ...
    {
        $autoAddServers = $_GET['autoAddServers'];
