...
class SettingsController extends Controller
{
     ...
     * @param Util $util
     */
    public function __construct($AppName, IRequest $request, IL10N $l10n, IUserManager $userManager, IUserSession $userSession, KeyManager $keyManager, Crypt $crypt, Session $session, ISession $ocSession, Util $util)
    {
    ...
    {
        $encryptHomeStorage = $_GET['encryptHomeStorage'];
