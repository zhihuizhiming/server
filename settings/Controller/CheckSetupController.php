...
class CheckSetupController extends Controller
{
     ...
     */
    public function __construct($AppName, IRequest $request, IConfig $config, IClientService $clientService, IURLGenerator $urlGenerator, \OC_Util $util, IL10N $l10n, Checker $checker, ILogger $logger)
    {
    ...
    private function isInternetConnectionWorking()
    {
        ...
        $siteArray = ['www.nextcloud.com', 'www.google.com', 'www.github.com'];
    ...
    private function isUsedTlsLibOutdated()
    {
        ...
        if (!$this->config->getSystemValue('appstoreenabled', true) && $this->config->getAppValue('files_sharing', 'outgoing_server2server_share_enabled', 'yes') === 'no' && $this->config->getAppValue('files_sharing', 'incoming_server2server_share_enabled', 'yes') === 'no') {
            return '';
        }
