...
class MailSettingsController extends Controller
{
     ...
     */
    public function __construct($appName, IRequest $request, IL10N $l10n, IConfig $config, IUserSession $userSession, IMailer $mailer, $fromMailAddress)
    {
    ...
    {
        $mail_smtpport = $_GET['mail_smtpport'];
        $mail_smtpauth = $_GET['mail_smtpauth'];
        $mail_smtpauthtype = $_GET['mail_smtpauthtype'];
        $mail_smtphost = $_GET['mail_smtphost'];
        $mail_smtpsecure = $_GET['mail_smtpsecure'];
        $mail_smtpmode = $_GET['mail_smtpmode'];
        $mail_from_address = $_GET['mail_from_address'];
        $mail_domain = $_GET['mail_domain'];
    ...
    {
        $mail_smtppassword = $_GET['mail_smtppassword'];
        $mail_smtpname = $_GET['mail_smtpname'];
