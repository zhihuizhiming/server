...
class GroupsController extends Controller
{
     ...
     * @param IL10N $l10n
     */
    public function __construct($appName, IRequest $request, IGroupManager $groupManager, IUserSession $userSession, $isAdmin, IL10N $l10n)
    {
    ...
    {
        $sortGroups = $_GET['sortGroups'];
        $filterGroups = $_GET['filterGroups'];
        $pattern = $_GET['pattern'];
        $groupPattern = $filterGroups ? $pattern : '';
        $groupsInfo = new MetaData($this->userSession->getUser()->getUID(), $this->isAdmin, $this->groupManager, $this->userSession);
