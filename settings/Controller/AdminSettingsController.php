...
class AdminSettingsController extends Controller
{
     ...
     */
    public function __construct($appName, IRequest $request, INavigationManager $navigationManager, ISettingsManager $settingsManager)
    {
    ...
    private function getNavigationParameters($currentSection)
    {
        ...
        foreach ($sections as $prioritizedSections) {
            foreach ($prioritizedSections as $section) {
                $templateParameters[] = ['anchor' => $section->getID(), 'section-name' => $section->getName(), 'active' => $section->getID() === $currentSection];
            }
        }
        return ['forms' => $templateParameters];
    }
}