...
class CertificateController extends Controller
{
     ...
     */
    public function __construct($appName, IRequest $request, ICertificateManager $userCertificateManager, ICertificateManager $systemCertificateManager, IL10N $l10n, IAppManager $appManager)
    {
    ...
    {
        $certificateIdentifier = $_GET['certificateIdentifier'];
        if ($this->isCertificateImportAllowed() === false) {
